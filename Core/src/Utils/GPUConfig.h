...
private:
          ...
          so3StepBlocks(64)
    {
        ...
        icpStepMap["GeForce RTX 3080"] = std::pair<int, int>(64, 240);
        rgbStepMap["GeForce RTX 3080"] = std::pair<int, int>(128, 96);
        rgbResMap["GeForce RTX 3080"] = std::pair<int, int>(256, 464);
        so3StepMap["GeForce RTX 3080"] = std::pair<int, int>(256, 48);
